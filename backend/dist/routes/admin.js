...
exports.adminRoutes.post('/users/create', AdminController_1.AdminController.createUser);
exports.adminRoutes.post('/users/update', AdminController_1.AdminController.updateUser);
exports.adminRoutes.post('/users/reset-password', AdminController_1.AdminController.resetUserPassword);
